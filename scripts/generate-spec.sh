...
# --- Step 2: Dynamically Discover the Latest Image Tag (Corrected) ---
echo "Searching for latest Argo CD tag..."
# CORRECTED: Added `grep -v -- "-source$"` to exclude source tags.
...
# --- Step 3: Construct full image URLs ---
...
# --- Step 4: Create the spec file from the template ---
cp microshift-gitops.spec.in microshift-gitops.spec

# --- Step 5: Get SHA IDs using skopeo inspect ---
