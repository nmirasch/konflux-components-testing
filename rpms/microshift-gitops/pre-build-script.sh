...
# - skopeo
# - yq
echo "__________________________________________________ Building microshift-gitops.spec inside dir  file"
# --- ARGO-CD variables ---
...
echo "__________________________________________________Created microshift-gitops inside dir .spec file"